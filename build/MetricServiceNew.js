...
exports.MetricServiceNew = void 0;
var MetricCalculator_1 = require("./main/MetricCalculator");
var MetricServiceNew = /** @class */ (function () {
    function MetricServiceNew() {
        this._compileAnswer = {};
    }
    MetricServiceNew.prototype.calculate = function (entryMarkupObject) {
        //@ts-ignore
    ...
    MetricServiceNew.prototype.fillAnswer = function (mainMarkupId, psrConcreteResult) {
    ...
    MetricServiceNew.prototype.calcAccuracy = function (mainMarkupId, expertMarker) {
        var numenator = 0;
        var denominator = 0;
        for (var i in this._compileAnswer.markups) {
            if (this._compileAnswer.markups[i].id === mainMarkupId) {
    ...
    MetricServiceNew.prototype.calcFinalOtar = function (mainMarkupId, expertMarker) {
        var averageSter = 0;
        var star = 0;
    ...
    return MetricServiceNew;
}());
exports.MetricServiceNew = MetricServiceNew;
