...
var MathMachine_1 = require("./main/MathMachine");
console.log(123);
var a = [1, 2, 3, 4, 5];
/* разметка пример */
...
// let y = z(51, 55);
// console.log(y);
var m = new MathMachine_1.MathMachine([{ start: 1, end: 15, determFactor: 'A' }, { start: 20, end: 27, determFactor: 'B' }, { start: 30, end: 45, determFactor: 'C' }], [{ start: 1, end: 10, determFactor: 'A' }, { start: 20, end: 25, determFactor: 'B' }, { start: 33, end: 40, determFactor: 'C' }, { start: 40, end: 45, determFactor: 'D' }]);
m.calcJaccardMatrix();
m.calcLossMatrix();
